...
{
    [Route("v1/api/agent/correctionreq/")]
    [ApiController]
    public class CorrectionRequestController : Controller
    {
        private readonly ILogger<CorrectionRequestController> _logger;

        private readonly IConfiguration _configuration;

        public CorrectionRequestController(ILogger<CorrectionRequestController> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        [HttpPost("ApplyCorrectionReq", Name = "ApplyCorrectionRequest")]
        public IActionResult ApplyCorrectionRequest([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_CorrectionRequest_Common");
        ...
        [HttpPost("GetCorrectionRequest", Name = "GetCorrectionRequest")]
        public IActionResult GetCorrectionRequest([FromBody] object reqObject)
        {
