...
namespace MilkIN_API.Areas.AgentApp_API.Controllers
{
    ...
    public class ReportsController : Controller
    {
        ...
        [HttpPost("GetReport", Name = "GetReport")]
        public IActionResult GetReport([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_AgentReport_Get");
