...
namespace MilkIN_API.Areas.AgentApp_API.Controllers
{
    ...
    public class ExpenseController : Controller
    {
        ...
        public IActionResult SaveExpense([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_AgentExpense_Common");
        ...
        [HttpPost("GetExpense", Name = "GetExpense")]
        public IActionResult GetExpense([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
