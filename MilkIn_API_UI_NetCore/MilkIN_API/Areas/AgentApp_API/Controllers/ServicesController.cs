...
namespace MilkIN_API.Areas.AgentApp_API.Controllers
{
    ...
    public class ServicesController : Controller
    {
        ...
        [HttpPost("AgGetServices", Name = "AgGetServices")]
        public IActionResult AgGetServices([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_AgentServices_Get");
        ...
        [HttpPost("ApplyServices", Name = "ApplyServices")]
        public IActionResult ApplyServices([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                dynamic inputParam = JsonConvert.DeserializeObject(reqObject.ToString());
                string destination_name = inputParam.Destination_Name;
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_AgentApplyService_Set");
