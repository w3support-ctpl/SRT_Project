...
namespace MilkIN_API.Areas.AgentApp_API.Controllers
{
    ...
    public class FarmerProfileController : Controller
    {
        ...
        public FarmerProfileController(ILogger<FarmerProfileController> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        [HttpPost("SaveFarmer", Name = "CreateFarmer")]
        public IActionResult CreateFarmer([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_AgentFarmerProfile_Set");
        ...
        [HttpPost("SaveFarmers", Name = "SaveFarmers")]
        public IActionResult SaveFarmers([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_AgentFarmerProfiles_Set");
        ...
        [HttpPost("GetFarmers", Name = "GetFarmers")]
        public IActionResult GetFarmers([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_AgentFarmerProfiles_Get");
