...
{
    [Route("v1/api/agent/performance/")]
    [ApiController]
    public class AgentPerformanceController : Controller
    {
        private readonly ILogger<AgentPerformanceController> _logger;

        private readonly IConfiguration _configuration;

        public AgentPerformanceController(ILogger<AgentPerformanceController> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        [HttpPost("GetAgentPerformance", Name = "GetAgentPerformance")]
        public IActionResult GetAgentPerformance([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_AgentPerformance");
