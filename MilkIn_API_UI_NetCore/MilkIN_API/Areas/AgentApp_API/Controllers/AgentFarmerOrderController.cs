...
namespace MilkIN_API.Areas.AgentApp_API.Controllers
{
    ...
    [ApiController]
    public class AgentFarmerOrderController : Controller
    {
        private readonly ILogger<AgentFarmerOrderController> _logger;

        private readonly IConfiguration _configuration;

        public AgentFarmerOrderController(ILogger<AgentFarmerOrderController> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        [HttpPost("AgentFarmerGetProduct", Name = "AgentFarmerGetProduct")]
        public IActionResult AgentFarmerGetProduct([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_AgentFarmerOrder");
        ...
        [HttpPost("AgentFarmerPlaceOrder", Name = "AgentFarmerPlaceOrder")]
        public IActionResult AgentFarmerPlaceOrder([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
        ...
        [HttpPost("AgentFarmerGetOrder", Name = "AgentFarmerGetOrder")]
        public IActionResult AgentFarmerGetOrder([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
