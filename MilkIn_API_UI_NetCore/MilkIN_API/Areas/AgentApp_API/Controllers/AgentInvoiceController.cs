...
{
    [Route("v1/api/agent/invoice/")]
    [ApiController]
    public class AgentInvoiceController : Controller
    {
        private readonly ILogger<AgentInvoiceController> _logger;

        private readonly IConfiguration _configuration;

        public AgentInvoiceController(ILogger<AgentInvoiceController> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        [HttpPost("GetAgInvoice", Name = "GetAgInvoice")]
        public IActionResult GetAgInvoice([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_AgentInvoice_Get");
