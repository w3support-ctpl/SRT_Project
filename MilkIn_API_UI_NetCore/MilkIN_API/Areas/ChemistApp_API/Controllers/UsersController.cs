...
namespace MilkIN_API.Areas.ChemistApp_API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        [HttpPost("CHSignIn", Name = "ChemistSignIn")]
        public IActionResult ChemistSignIn([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_ChemistSign_In");
