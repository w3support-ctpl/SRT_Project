...
namespace MilkIN_API.Areas.ChemistApp_API.DAL
{
    public class CommonDAL
    {
        ...
        public string RunDBQuery(dynamic InputParam, string StoredProcName)
        {
            ...
            dynamic resObj = this.db.Query<dynamic>(StoredProcName, parameters, commandType: CommandType.StoredProcedure,commandTimeout: null).ToList();
