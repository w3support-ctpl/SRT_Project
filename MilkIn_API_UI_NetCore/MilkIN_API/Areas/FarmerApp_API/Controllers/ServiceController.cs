...
namespace MilkIN_API.Areas.FarmerApp_API.Controllers
{
    ...
    public class ServiceController : Controller
    {
        ...
        [HttpPost("GetService", Name = "GetService")]
        public IActionResult GetService([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_FarmerService_Get");
        ...
        [HttpPost("SaveService", Name = "SaveService")]
        public IActionResult SaveService([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                dynamic inputParam = JsonConvert.DeserializeObject(reqObject.ToString());
                string destination_name = inputParam.Destination_Name;
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_FarmerService_Set");
