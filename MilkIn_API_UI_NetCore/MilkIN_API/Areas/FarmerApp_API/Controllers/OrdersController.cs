...
namespace MilkIN_API.Areas.FarmerApp_API.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public IActionResult GetProduct([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_FarmerOrder");
        ...
        [HttpPost("FarmerPlaceOrder", Name = "FarmerPlaceOrder")]
        public IActionResult FarmerPlaceOrder([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
        ...
        [HttpPost("FarmerGetOrder", Name = "FarmerGetOrder")]
        public IActionResult FarmerGetOrder([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
