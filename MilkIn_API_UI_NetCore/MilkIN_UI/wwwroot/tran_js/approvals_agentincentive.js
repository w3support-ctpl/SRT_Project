$(document).ready(function () {
    ...
    //SetDataTable("tableSearch", [6], "Agent Incentive");
...
function GetSearchList(e) {
    ...
    var url = "/Approvals/AgentIncentive";

    var APIEndPoint = "GetAgentIncentive";
    var Method_Name = "Get";
...
function ShowApproveEntry(Request_Id, _AgentId, Agent_Name, Scheme_Name, Mobile_No) {
    Agent_Id = _AgentId

    ShowContentDiv("Approvals", "AgentIncentiveAdd", "", function () {
        // Initialization Code
        $("#btn_Save").hide();
        ...
        $.ajax({
            ...
            error: function () {
                Show_Error_Toastr("Error : Agent Incentive details not found");
            }
        });
...
function SaveEntry() {
    ...
    // Save
    var APIEndPoint = "SaveAgentIncentive";
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (result[0].result_id == 1) {
                ...
                Show_Success_Toastr("Agent Incentive " + result[0].result_description);
                CloseEntry();
        ...
        error: function () {
            Show_Error_Toastr("Error : Agent Incentive details not saved");
            $("#btn_Save").prop('disabled', false);
        }
    });
}
