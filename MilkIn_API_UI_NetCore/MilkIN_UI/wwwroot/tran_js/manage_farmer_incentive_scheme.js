...
function GetSearchList(e) {
    ...
    //Validate Data
    var APIEndPoint = "GetFarmerIncentiveSchemes";
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            SetDataTable("tableSearch", [5], "Farmer Incentive Schemes");
...
function ShowEditEntry(IncentiveScheme_Id) {
    ShowContentDiv("Manage", "FarmerIncentiveSchemesEdit", "", function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#txtEntrySchemeStartDate").text(res.formatted_from_date);
                $("#txtEntrySchemeEndDate").text(res.formatted_to_date);
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                // assign values to input fields
                if (res.length == 0) {
                    ShowEntryError("No Farmers eligible for this scheme.");
                    return;
                }
                var TableHTML = "";
                // var EditFlag = 1;
                ...
                ClearDataTable("tableFarmerList");
                $("#tableEntryFarmerList").html(TableHTML);
                SetDataTable("tableFarmerList", [5], "Farmer List");
