$(document).ready(function () {
    ...
    //SetDataTable("tableSearch", [6], "Farmer Orders");
...
function GetSearchList(e) {
    ...
    var url = "/Approvals/FarmerOrder";
    var APIEndPoint = "GetFarmerOrder";
    var Method_Name = "Get";
...
function ShowApproveEntry(Order_Id, _OrderForId, Farmer_Name, Mobile_No) {
    OrderFor_Id = _OrderForId;
    ShowContentDiv("Approvals", "FarmerOrdersAdd", "", function () {
        // Initialization Code
        $("#btn_Save").hide();
        ...
        $.ajax({
            ...
            error: function () {
                Show_Error_Toastr("Error : Farmer Order details not found");
            }
        });
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                SetDataTable("tableOrderEntry", [6], "Farmer Orders");
...
function SaveEntry() {
    ...
    $("#tableOrderEntry tbody tr").each(function () {
        ...
        OrderDetails += "<Rate>" + $(this).find("td:eq(5)").text() + "</Rate>";
        OrderDetails += "</ProductItem>";
    });
    OrderDetails += "</Products>";
    ...
    // Save
    var APIEndPoint = "SaveFarmerOrder";
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (result[0].result_id == 1) {
                ...
                Show_Success_Toastr("Farmer Order " + result[0].result_description);
                CloseEntry();
        ...
        error: function () {
            Show_Error_Toastr("Error : Farmer Order details not saved");
            $("#btn_Save").prop('disabled', false);
        }
    });
}
