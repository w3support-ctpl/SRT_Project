...
function GetSearchList(e) {
  ...
  var url = "/Approvals/AgentService";

  var APIEndPoint = "GetAgentService";
  var Method_Name = "Get";
  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      SetDataTable("tableSearch", [6], "Agent Service");
...
function ShowApproveEntry(
  ...
  ShowContentDiv("Approvals", "AgentServiceAdd", "", function () {
    // Initialization Code
    $("#btn_Save").hide();
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        if (ServiceType_Id == "C026002") {
          ...
          $("#txtEntryAgentRemarksFinancial").val(res[0].request_remark);
        }
        // Veterinary Service
          ...
          $("#txtEntryAgentRemarksVeterinary").val(res[0].request_remark);
        }
        // Material Service
          ...
          SetDataTable("tableMaterialEntry", [6], "Agent Service");

          $("#divRemarks").attr("class", "col-lg-9 col-md-4 col-sm-12");
        }
      },
      error: function () {
        Show_Error_Toastr("Error : Agent Service details not found");
      },
    });
  });
}
...
function SaveEntry() {
  ...
  // Save
  var APIEndPoint = "SaveAgentService";
  Method_Name = "Update";
  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      if (result[0].result_id == 1) {
        ...
        Show_Success_Toastr("Agent Service " + result[0].result_description);
        CloseEntry();
      } else {
    ...
    error: function () {
      Show_Error_Toastr("Error : Agent Service details not saved");
      $("#btn_Save").prop("disabled", false);
    },
  });
}
