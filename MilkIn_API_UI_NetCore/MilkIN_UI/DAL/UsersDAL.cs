...
//        public ResAPICommonOutput GetFarmer(ReqFarmerSearch farmerSearch)
//        {
//            ResAPICommonOutput resOut = new ResAPICommonOutput();
//            farmerSearch.destination_name = Destination_Name;
//            try
//            {
...
//                    //HTTP POST
//                    var postTask = client.PostAsJsonAsync<ReqFarmerSearch>("/v1/api/admin/users/GetFarmer", farmerSearch);
//                    postTask.Wait();
...
//        public ResAPICommonOutput GetAgent(ReqAgentSearch agentSearch)
//        {
//            ResAPICommonOutput resOut = new ResAPICommonOutput();
//            agentSearch.destination_name = Destination_Name;
//            try
//            {
//                using (var client = new HttpClient())
//                {
...
//                    //HTTP POST
//                    var postTask = client.PostAsJsonAsync<ReqAgentSearch>("/v1/api/admin/users/GetAgent", agentSearch);
//                    postTask.Wait();
...
//                    //HTTP POST
//                    var postTask = client.PostAsJsonAsync<ReqAgentSave>("/v1/api/admin/users/SaveAgent", agentSave);
//                    postTask.Wait();
...
//        public ResAPICommonOutput GetDriver(ReqDriverSearch driverSearch)
//        {
//            ResAPICommonOutput resOut = new ResAPICommonOutput();
//            driverSearch.destination_name = Destination_Name;
//            try
//            {
//                using (var client = new HttpClient())
//                {
...
//                    //HTTP POST
//                    var postTask = client.PostAsJsonAsync<ReqDriverSearch>("/v1/api/admin/users/GetDriver", driverSearch);
//                    postTask.Wait();
...
//        public ResAPICommonOutput GetChemist(ReqChemistSearch chemistSearch)
//        {
//            ResAPICommonOutput resOut = new ResAPICommonOutput();
//            chemistSearch.destination_name = Destination_Name;
//            try
//            {
//                using (var client = new HttpClient())
//                {
...
//                    //HTTP POST
//                    var postTask = client.PostAsJsonAsync<ReqChemistSearch>("/v1/api/admin/users/GetChemist", chemistSearch);
//                    postTask.Wait();
...
//        public ResAPICommonOutput GetUser(ReqUserSearch userSearch)
//        {
//            ResAPICommonOutput resOut = new ResAPICommonOutput();
...
//                    //HTTP POST
//                    var postTask = client.PostAsJsonAsync<ReqUserSearch>("/v1/api/admin/users/GetUser", userSearch);
//                    postTask.Wait();
