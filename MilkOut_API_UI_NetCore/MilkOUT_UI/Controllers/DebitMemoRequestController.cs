...
namespace MilkOUT_UI.Controllers
{
    public class DebitMemoRequestController : Controller
    {
        ...
        {
            return View("DebitMemoRequest");
        }


        public IActionResult ShowDebitMemo()
        {
            return PartialView("_DebitMemoEntry");
        }
        ...
        public IActionResult GetDebitMemoRequest([FromBody] object reqObject)
        {
            try
            {
                ...
                string APIEndPoint = "/v1/api/admin/debitmemo/" + inputParam.api_end_point;
