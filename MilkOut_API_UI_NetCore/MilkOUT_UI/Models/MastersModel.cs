namespace MilkOUT_UI.Models
{
    ...
    /*----  ----    ----    ----    Role - Request Model   ----    ----    ----    ----*/
    public class ReqDownloadDealer
    {
        // REQUIRED FIELDS IN EVERY MODEL
        public string? method_name { get; set; }
        public string? org_id { get; set; }
