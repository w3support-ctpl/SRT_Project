...
//        [HttpPost("GetSalesInvoice", Name = "GetSalesInvoice")]
//        public IActionResult GetSalesInvoice([FromBody] object reqObject)
//        {
//            try
//            {
//                if (reqObject == null)
...
//                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_SalesInvoice_Get");
