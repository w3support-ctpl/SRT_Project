...
namespace MilkOUT_API.Areas.SalesApp_API.Controllers
{
    ...
    public class CrateController : Controller
    {
        ...
        public CrateController(ILogger<CrateController> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        [HttpPost("SalesManageCrate", Name = "SalesManageCrate")]
        public IActionResult SalesManageCrate([FromBody] object reqObject)
        {
            try
            {
                if (reqObject == null)
                ...
                string res_Str = new CommonDAL(destination_name, _configuration).RunDBQuery(inputParam, "USP_SalesUserCrate");
